...
describe('Demo of menu buttons', function () {
    ...
    it('should open and click on redial', function () {
        console.log('hallo!');
        var rootEl = $('[demo-id=\"menudemoBasicUsage\"]');
        var menu = _node_modulesSpectangularDistSpectangularJs2['default'].menuButton({ rootEl: rootEl });
        console.log('2');
        if (!menu) {
            console.log('menu not found!');
        }
        menu.openAndClickItem({ text: 'redial' });

...
var Container = (function (_Component) {
  ...
  _createClass(Container, [{
    key: 'clickComponent',
    value: function clickComponent(config) {
      if (!config.selector) {
      ...
      _spectangularJs2['default'].component(config).click();
      return this;
    }
  }, {
    key: 'clickButton',
    value: function clickButton() {
      ...
      _spectangularJs2['default'].button(config).click();
      return this;
    }
  }, {
    key: 'switchTab',
    value: function switchTab() {
      ...
      _spectangularJs2['default'].tab(config).click();
      return this;
    }
  }]);

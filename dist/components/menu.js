...
var Menu = (function (_Container) {
  ...
  _createClass(Menu, [{
    key: 'clickItem',
    value: function clickItem(config) {
      if (config.text) {
    ...
    key: 'clickItemByIndex',
    value: function clickItemByIndex(index) {
      return this.menuItems.get(index).click();
    }
  }, {
    key: 'clickItemByText',
    value: function clickItemByText(text) {
      return this.menuItems.filter(function (el) {
        return el.getText().then(function (itemText) {
